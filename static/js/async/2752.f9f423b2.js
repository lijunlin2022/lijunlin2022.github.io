"use strict";(self.webpackChunkmy_website=self.webpackChunkmy_website||[]).push([["2752"],{87663:function(e,n,r){r.r(n),r.d(n,{default:()=>x});var t=r("85893"),s=r("50065"),i=r("95895"),a=r("67294"),o=r("1001"),c=r("72555");let l=new(r("94970")).$T,{scripts:h,styles:d}=l.getAssets();"undefined"!=typeof window&&((0,c.j)(d),(0,c.fs)(h,{getMarkmap:()=>o}));var f=r("70243");r("59723");let u={minHeight:"50vh",backgroundColor:"#f1f1f1"};function m(e){let{markdown:n}=e,[r]=(0,a.useState)(n),[s,i]=(0,a.useState)(u),c=(0,a.useRef)(),h=(0,a.useRef)(),d=(0,a.useRef)(),m=(e,n)=>{for(;null==n?void 0:n.firstChild;)n.firstChild.remove();if(e&&n){let r=new f.o;r.attach(e),r.register({id:"full",title:"full screen",content:f.o.icon("M16 4h-12v12h12v-8h-8v4h2v-2h4v4h-8v-8h10z"),onClick:()=>{var e;let n=null===(e=document.getElementsByClassName("rspress-sidebar"))||void 0===e?void 0:e[0],r=document.getElementById("aside-container");if(!!n&&!!r){if("fixed"===c.current.style.position){i(u),n.style.display="block",r.style.display="block";return}i({position:"fixed",zIndex:1,right:0,bottom:0,width:"100vw",height:"calc(100vh - var(--rp-nav-height))",backgroundColor:"#f1f1f1"}),n.style.display="none",r.style.display="none"}}}),r.setItems(["zoomIn","zoomOut","fit","full"]),n.append(r.render())}};return(0,a.useEffect)(()=>{if(h.current)return;let e=o.Markmap.create(c.current);h.current=e,m(h.current,d.current)},[c.current]),(0,a.useEffect)(()=>{let e=h.current;if(!e)return;let{root:n}=l.transform(r);e.setData(n),e.fit()},[h.current,r]),(0,a.useEffect)(()=>{let e=h.current;if(!!e)e.fit()},[s]),(0,t.jsx)(a.Fragment,{children:(0,t.jsxs)("div",{className:"relative",style:s,children:[(0,t.jsx)("svg",{className:"w-full h-full",ref:c,style:s}),(0,t.jsx)("div",{className:"absolute bottom-0 right-0 z-10",ref:d})]})})}function p(e){let n=Object.assign({h2:"h2",a:"a",pre:"pre",code:"code"},(0,s.ah)(),e.components);return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)(n.h2,{id:"思维导图",children:[(0,t.jsx)(n.a,{className:"header-anchor","aria-hidden":"true",href:"#思维导图",children:"#"}),"思维导图"]}),"\n",(0,t.jsx)(i.Z,{defaultLocale:"zh-CN"}),"\n",(0,t.jsx)(m,{markdown:`
