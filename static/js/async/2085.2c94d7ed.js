"use strict";(self.webpackChunkmy_website=self.webpackChunkmy_website||[]).push([["2085"],{92178:function(e,n,r){r.r(n),r.d(n,{default:()=>j});var t=r("85893"),s=r("50065"),i=r("67294"),a=r("1001"),o=r("72555");let c=new(r("94970")).$T,{scripts:l,styles:h}=c.getAssets();"undefined"!=typeof window&&((0,o.j)(h),(0,o.fs)(l,{getMarkmap:()=>a}));var d=r("70243");r("59723");let f={minHeight:"50vh",backgroundColor:"#f1f1f1"};function u(e){let{markdown:n}=e,[r]=(0,i.useState)(n),[s,o]=(0,i.useState)(f),l=(0,i.useRef)(),h=(0,i.useRef)(),u=(0,i.useRef)(),m=(e,n)=>{for(;null==n?void 0:n.firstChild;)n.firstChild.remove();if(e&&n){let r=new d.o;r.attach(e),r.register({id:"full",title:"full screen",content:d.o.icon("M16 4h-12v12h12v-8h-8v4h2v-2h4v4h-8v-8h10z"),onClick:()=>{var e;let n=null===(e=document.getElementsByClassName("rspress-sidebar"))||void 0===e?void 0:e[0],r=document.getElementById("aside-container");if(!!n&&!!r){if("fixed"===l.current.style.position){o(f),n.style.display="block",r.style.display="block";return}o({position:"fixed",zIndex:1,right:0,bottom:0,width:"100vw",height:"calc(100vh - var(--rp-nav-height))",backgroundColor:"#f1f1f1"}),n.style.display="none",r.style.display="none"}}}),r.setItems(["zoomIn","zoomOut","fit","full"]),n.append(r.render())}};return(0,i.useEffect)(()=>{if(h.current)return;let e=a.Markmap.create(l.current);h.current=e,m(h.current,u.current)},[l.current]),(0,i.useEffect)(()=>{let e=h.current;if(!e)return;let{root:n}=c.transform(r);e.setData(n),e.fit()},[h.current,r]),(0,i.useEffect)(()=>{let e=h.current;if(!!e)e.fit()},[s]),(0,t.jsx)(i.Fragment,{children:(0,t.jsxs)("div",{className:"relative",style:s,children:[(0,t.jsx)("svg",{className:"w-full h-full",ref:l,style:s}),(0,t.jsx)("div",{className:"absolute bottom-0 right-0 z-10",ref:u})]})})}function m(e){let n=Object.assign({h2:"h2",a:"a",pre:"pre",code:"code"},(0,s.ah)(),e.components);return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)(n.h2,{id:"思维导图",children:[(0,t.jsx)(n.a,{className:"header-anchor","aria-hidden":"true",href:"#思维导图",children:"#"}),"思维导图"]}),"\n",(0,t.jsx)(u,{markdown:`
